  ...
  return (
    <div className="min-h-screen bg-[#FFF0F3] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-[#FFB6C1]/30 blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-[#F8BBD9]/30 blur-3xl" />
      </div>
      ...
      <div className="relative bg-white rounded-3xl p-10 shadow-xl border border-pink-100 w-full max-w-sm text-center animate-scale-in">
        {/* Logo */}
        <div className="w-16 h-16 bg-gradient-to-br from-[#C2185B] to-[#F48FB1] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
